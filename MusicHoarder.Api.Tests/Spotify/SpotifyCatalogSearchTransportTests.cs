...
public class SpotifyCatalogSearchTransportTests
{
    ...
    /// <summary>
    /// Replays scripted responses in order and records every request (the service disposes its
    /// <see cref="HttpRequestMessage"/>s, so what a test needs is captured at send time).
    /// </summary>
