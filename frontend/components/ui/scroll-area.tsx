  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        ...
        // [&>div]:!block overrides Radix's internal display:table wrapper, which otherwise lets
        // long unbroken children push the row past the viewport and defeat `truncate` on siblings.
