...
{#if playerStore.currentSong && !playerStore.isPanelMounted}
  ...
  <div
    class="border-border bg-sidebar fixed right-0 left-0 z-50 border-t shadow-[0_-4px_24px_oklch(0%_0_0/0.08)] bottom-[calc(84px+env(safe-area-inset-bottom))] md:bottom-[env(safe-area-inset-bottom)] dark:shadow-[0_-4px_20px_rgba(0,0,0,0.35)]"
  >
