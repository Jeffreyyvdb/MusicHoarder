...
export const faqPageSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'A .NET ASP.NET Core API with a SvelteKit (Svelte 5) frontend, orchestrated via .NET Aspire. Data is persisted in PostgreSQL. Audio fingerprinting uses Chromaprint/fpcalc.'
      }
    }
  ]
};
