...
builder.Services.AddSingleton<IEnrichmentProvider, AcoustIdEnrichmentProvider>();
builder.Services.AddSingleton<IEnrichmentProvider, MusicBrainzWebEnrichmentProvider>();
builder.Services.AddSingleton<IEnrichmentProvider, SpotifyApiEnrichmentProvider>();
builder.Services.AddSingleton<IEnrichmentProvider, TrackerEnrichmentProvider>();
