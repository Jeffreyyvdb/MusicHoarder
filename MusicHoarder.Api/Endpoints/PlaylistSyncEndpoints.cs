...
public static class PlaylistSyncEndpoints
{
    public static IEndpointRouteBuilder MapPlaylistSyncEndpoints(this IEndpointRouteBuilder app)
    {
        var group = app.MapGroup("/api/playlist-sync").WithTags("Playlist sync").RequireAdmin();
