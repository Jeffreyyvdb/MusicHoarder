    ...
    : SaveChangesInterceptor
{
    ...
    [
        ...
        nameof(SongMetadata.Genre),
        nameof(SongMetadata.ReleaseDate),
        nameof(SongMetadata.OriginalReleaseDate),
        nameof(SongMetadata.Label),
        nameof(SongMetadata.CatalogNumber),
        nameof(SongMetadata.Upc),
        nameof(SongMetadata.Composer),
        nameof(SongMetadata.Copyright),
        nameof(SongMetadata.ArtistSort),
