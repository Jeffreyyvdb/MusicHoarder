...
{
    /// <inheritdoc />
    public partial class AddChatAndWebPush : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WebPushKeys", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkProvider = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                    LinkKind = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                    LinkTitle = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    LinkSubtitle = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    LinkImageUrl = table.Column<string>(type: "character varying(2048)", maxLength: 2048, nullable: true),
                    VisibleToUserId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatMessages_SongShares_ShareId",
                        column: x => x.ShareId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMessages_ShareId_VisibleToUserId",
                table: "ChatMessages",
                columns: new[] { "ShareId", "VisibleToUserId" });
