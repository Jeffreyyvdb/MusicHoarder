...
data class MhColors(
     ...
     *  an alpha-dimmed [mutedForeground], which drops text below 4.5:1. */
     ...
     *  is the fill under [destructiveForeground]; as dark-theme text it was 3.74:1. */
...
val MhLightColors = MhColors(
    ...
    mutedForegroundDim = Color(0xFF626975),
